...
import { CreateParticipationRequestBody, Participation, ValidateResultRequestBody, CreateParticipationResponse, ValidationResultResponse } from '../../../shared/types';
    ...
    .onRequest((request, response) => {
        return c(request, response, async () => {
            ...
            if (!isValid) {
                ...
                response.status(200).send({ isValid: true } as ValidationResultResponse);
            }
        });
    });
